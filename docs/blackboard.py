...
"""
Some actions are subclasses of Undoable, which means that they possess an
...
"""
Can we also make actions which are incrementally constructed by the user,
like an insertion operation?
"""
...
class InsertOperation(Operation):
    def feed(self, session, string):
        # logic here
        session.actiontree.hardundo()
        self(session)
